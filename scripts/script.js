...
var strArr = ['a0', 'b1', 'c2', 'd3', 'e4'];
// - з 5 значень стрічкового, числового та булевого типу
var anyArr = [0, 'b1', true, 4, false];
...
var numArr2 = [0, 11, 22, 33, 44, 55, 66, 77, 88, 99];
for (var i = 0; i < numArr2.length; i++) {
    console.log(numArr2[i]);
}
// - Створити масив з 10 строкрових елементів. Вивести в консоль всі його елементи в циклі.
var strArr2 = ['0', '11', '22', '33', '44', '55', '66', '77', '88', '99'];
for (var i = 0; i < strArr2.length; i++) {
    console.log(strArr2[i]);
}
// - Створити масив з 10 елементів будь-якого типу. Вивести в консоль всі його елементи в циклі.
var anyArr3 = ['0', 11, '22', 33, true, 'false', false, '77', 88, '99'];
for (var i = 0; i < anyArr3.length; i++) {
    console.log(anyArr3[i]);
}
// - Створити масив з 10 елементів числового, стірчкового і булевого типу. За допомогою if та typeof вивести тільки булеві елементи
var anyArr4 = ['true', 11, false, 33, true, 'false', false, '77', 88, '99'];
for (var i = 0; i < anyArr4.length; i++) {
    if (typeof anyArr4[i] === 'boolean') {
        console.log(anyArr4[i]);
    }
}
// - Створити масив з 10 елементів числового, стірчкового і булевого типу. За допомогою if та typeof вивести тільки числові елементи
var anyArr5 = [0, 11, false, 33, true, 'false', false, '77', 88, 99];
for (var i = 0; i < anyArr5.length; i++) {
    if (typeof anyArr5[i] === 'number') {
        console.log(anyArr5[i]);
    }
}
// - Створити масив з 10 елементів числового, стрічкового і булевого типу. За допомогою if та typeof вивести тільки рядкові елементи
var anyArr6 = ['000000', 11, false, 33, true, 'false', false, '77', 88, '999999'];
for (var i = 0; i < anyArr6.length; i++) {
...
anyArr7[8] = true;
anyArr7[9] = 'false';
for (var i = 0; i < anyArr7.length; i++) {
...
var UserPlusClient = /** @class */ (function () {
    function UserPlusClient() {
    }
    return UserPlusClient;
}());
// interface User {
//     id: number;
//     name: string;
...
for (var i = 0; i < usersWithId.length; i++) {
    for (var j = 0; j < clientsWithId.length; j++) {
