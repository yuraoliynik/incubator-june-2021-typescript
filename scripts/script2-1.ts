...
function arrLog(array: number[]): void {
    console.log(array);
}
...
function minNumber(num1: number, num2: number, num3: number): void {
    let minNum = num1;
...
function maxNumber(num1: number, num2: number, num3: number): void {
    let maxNum = num1;
...
function maxNumOfArr(arrayNumbers: number[]): number {
...
let arrNums: number[] = [20, 30, 2, 4, 6, 70, 54];
console.log(maxNumOfArr(arrNums));

// - створити функцію яка повертає найменьше число з масиву
function minNumOfArr(arrayNumbers: number[]): number {
...
function sumNumsOfArr(arrayNumbers: number[]): number {
    let sumNums = 0;
...
let arr2: number[] = [10, 4, 5, 5];
console.log(sumNumsOfArr(arr2));

// - створити функцію яка приймає масив чисел та повертає середнє арифметичне його значень.
function averageOfArrNums(arrayNumbers: number[]): number {
...
function fillEmptyArray(emptyArrayNumber: number[], numberOfElements: number): void {
...
function arrayOfPropertyName(arrayOfObject: object[]): string[] {
    let arrOfPropName = [];
...
let arr4: object[] = [{name: 'Dima', age: 13}, {model: 'Camry'}];
console.log(arrayOfPropertyName(arr4));

// - Створити функцію яка приймає масив будь яких объектів, та повертає масив значень всіх обєктів
// EXAMPLE:
//     [{name: 'Dima', age: 13}, {model: 'Camry'}]  ===> [ Dima, 13, Camry ]
function arrayOfValues(arrayOfObject: object[]): any[] {
    let arrOfVal = [];
...
// результат
//     [3,5,7,9]
function sumArrays(arrayNum1: number[], arrayNum2: number[]): number[] {
...
let arr13: number[] = [1, 2, 3, 4, 5, 110, 40, 55, 32, 5];
